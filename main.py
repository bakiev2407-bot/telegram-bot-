...
CHAT_TO_MONITOR = -1001484212179  # Группа "М. ДПС УЧАЛЫ🚔🚔🚔"
...
✅ Вы подписались на уведомления из группы "М. ДПС УЧАЛЫ".
...
💡 Теперь вы будете получать все новые сообщения из группы!"""
...
async def stop_handler(event):
    ...
    if user_id in subscribers:
        subscribers.remove(user_id)
        save_subscribers(subscribers)
        await event.reply("❌ **Вы отписались от уведомлений!**\nВы больше не будете получать сообщения из группы.")
